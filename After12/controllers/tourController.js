...
exports.getToursWithin = catchAsync(async(req, res, next) =>{
  ...
  if(!lat || !lng){
    next(new AppError('Please provide langitude and longitude in the format lat,lng.', 400));
  }
...
exports.getDistance = catchAsync(async(req, res, naxt) =>{
