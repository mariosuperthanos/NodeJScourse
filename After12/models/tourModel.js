...
// Virtual populate
tourSchema.virtual('reviews', { // create a virtual property called reviews
  ref: 'Review', // where to search in
  foreignField: 'tour', // the review's field that contain the ID of the current tour
  localField: '_id' // what field from Tour model to search for and compare
})
...
//   // replace the id with the user data
